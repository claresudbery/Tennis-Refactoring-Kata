...
namespace Tennis.Tests
{
    ...
    public class PinklishWIPTestDataGenerator : IEnumerable<object[]>
    {
        private readonly List<object[]> _data = new List<object[]>
        {
            new object[] {0,    0,  "Love-All"          , "Like-All"          },
            new object[] {1,    1,  "Fifteen-All"       , "Fifteen-All"       },
            new object[] {2,    2,  "Thirty-All"        , "Thirty-All"        },
            new object[] {3,    3,  "Deuce"             , "Deuce"             },
            new object[] {4,    4,  "Deuce"             , "Deuce"             },
            new object[] {1,    0,  "Fifteen-Love"      , "Fifteen-Like"      },
            new object[] {0,    1,  "Love-Fifteen"      , "Like-Fifteen"      },
            new object[] {2,    0,  "Thirty-Love"       , "Thirty-Like"       },
            new object[] {0,    2,  "Love-Thirty"       , "Like-Thirty"       },
            new object[] {3,    0,  "Forty-Love"        , "Forty-Like"        },
            new object[] {0,    3,  "Love-Forty"        , "Like-Forty"        },
